...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if(prodType == ProductType.TAZAS)
      return <ProductCup>[
        ProductCup(productTitle: "Normal",
         productDescription: "Una simple taza sin arte alguno.",
          productImage: "https://http2.mlstatic.com/144-tazas-promocion-blancas-11oz-sublimacion-sublimar-D_NQ_NP_628315-MLM25220111161_122016-F.jpg",
           productColor: ProductColor.W,
            productAmount: 0,
            ),
        ProductCup(productTitle: "Star Wars Stormtrooper",
         productDescription: "Taza con forma de los emblematicos casco Stromtrooper",
          productImage: "https://tienda.gvexpress.cr/wp-content/uploads/2018/11/1-66.jpg",
           productColor: ProductColor.W,
            productAmount: 0,
            ),
        ProductCup(productTitle: "Iron Man",
         productDescription: "Taza con forma del poderoso amo de la ingenieria Iron Man",
          productImage: "http://t0.gstatic.com/images?q=tbn%3AANd9GcQleU44vuoc8OpyHfPnmujGOVx7FHp6R9F2Tt5sCWmd2dN01C6iUQJWdEH-2x0MB_UuyzuDXOrq&usqp=CAc",
           productColor: ProductColor.W,
            productAmount: 0,
            ),
        ProductCup(productTitle: "Winnie The Pooh",
         productDescription: "Taza con forma de tarro de miel con el oso Pooh en el dibujo",
          productImage: "http://t0.gstatic.com/images?q=tbn%3AANd9GcTqVSnRrxmGqIzZ90yS_yKXfnuHSuJXq2byoNE5R--PsiuRxSDWD_ArlENaXHfXJqnnOWHkRO_3&usqp=CAc",
           productColor: ProductColor.W,
            productAmount: 0,
            ),
        ProductCup(productTitle: "Master Chief",
         productDescription: "Taza en forma del casco del reclamador de la Franquicia Halo",
          productImage: "https://cdn.shopify.com/s/files/1/2437/4099/products/halo-mug-3d-halo-x2_512x.jpg?v=1573452666",
           productColor: ProductColor.W,
            productAmount: 0,
            ),
      ];
